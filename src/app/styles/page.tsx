...
export const metadata: Metadata = {
  ...
  description:
    ...
    "bridal henna styles",
    "wedding mehndi varieties",
    "cultural henna patterns",
    "regional mehndi traditions",
    "henna art by region",
    "mehndi design styles",
    "henna pattern types",
    "geometric mehndi style",
    "floral henna style",
    ...
    "full hand henna styles",
    "finger mehndi styles",
    "mehndi style guide"
  ],
  alternates: {
    canonical: "/styles",
