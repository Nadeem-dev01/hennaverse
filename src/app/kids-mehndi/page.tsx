...
export const metadata: Metadata = {
  ...
  keywords: [
    "kids mehndi design",
    "children henna patterns",
    "simple mehndi for kids",
    "cute mehndi design",
    "easy henna for children",
    "kids mehndi 2025",
    "small mehndi for kids",
    "flower mehndi for kids",
    "star henna design kids",
    "butterfly mehndi children",
    "kids mehndi for eid",
    "kids mehndi for wedding",
    "simple henna kids",
    "quick mehndi for children",
    "fun mehndi designs kids",
    "cartoon mehndi for kids",
    "safe henna for children",
    "natural henna kids",
    "kids finger mehndi",
    "kids palm mehndi",
    "easy mehndi for girls",
    "simple henna for boys",
    "festival mehndi kids",
    "diwali mehndi children",
    "eid henna for kids",
    "birthday mehndi kids",
    "toddler mehndi design",
    "baby mehndi patterns",
    "kids mehndi images",
    "cute henna for children",
    "kids mehndi download",
    "adorable mehndi kids",
    "kids mehndi ideas",
    "easy mehndi patterns children",
    "heart mehndi for kids",
    "dot mehndi for kids",
    "kids mehndi step by step",
    "quick henna kids",
    "mini mehndi for children",
    "kids mehndi inspiration"
  ],
  alternates: {
