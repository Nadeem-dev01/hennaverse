        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://www.instagram.com/explore/tags/mehndidesign/"
                target="_blank"
              ...
              <a
                href="https://www.pinterest.com/search/pins/?q=mehndi%20designs"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.youtube.com/results?search_query=mehndi+design"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="text-muted hover:text-gold transition-colors"
              ...
              <a
                href="https://www.tiktok.com/tag/mehndidesign"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="text-muted hover:text-gold transition-colors"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-muted text-xs">
              © {currentYear} Mehndi Design Henna. All rights reserved.
            </p>
            <div className="flex items-center gap-4 text-xs text-muted">
              ...
              <Link href="/sitemap-html" className="hover:text-gold transition-colors">HTML Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
